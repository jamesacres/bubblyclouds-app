...
export interface UnblockRaceAppStackProps extends cdk.StackProps {
  certificateArn: string;
  domainName: string;
  subdomain?: string;
}

export class UnblockRaceAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: UnblockRaceAppStackProps) {
