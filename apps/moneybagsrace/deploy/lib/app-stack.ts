...
export interface MoneyBagsRaceAppStackProps extends cdk.StackProps {
  certificateArn: string;
  domainName: string;
  subdomain?: string;
}

export class MoneyBagsRaceAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: MoneyBagsRaceAppStackProps) {
