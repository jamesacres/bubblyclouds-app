...
jest.mock('@bubblyclouds-app/sudoku/helpers/puzzleTextToPuzzle', () => ({
...
describe('Book Page', () => {
  ...
  beforeEach(() => {
    ...
    const { useBook } = require('@bubblyclouds-app/sudoku/providers/BookProvider');
    ...
    const { useParties } = require('@bubblyclouds-app/template/hooks/useParties');
