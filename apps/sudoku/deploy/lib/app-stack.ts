...
export interface SudokuAppStackProps extends cdk.StackProps {
  certificateArn: string;
  domainName: string;
  subdomain?: string;
}

export class SudokuAppStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: SudokuAppStackProps) {
