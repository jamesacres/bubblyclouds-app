...
// (Note .co.uk was done manually in portal, redirect to .com is done with a s3 bucket for with and without www, static website redirect, but https doesnt work)
