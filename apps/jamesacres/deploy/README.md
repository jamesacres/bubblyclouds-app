...
AWS CDK stack that creates the infrastructure for deploying the James Acres blog
...
After building the app (`pnpm run build:jamesacres` from the repo root), sync
