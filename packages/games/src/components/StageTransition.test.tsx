...
describe('StageTransition', () => {
  it('renders the outgoing board and the incoming children side by side', () => {
    render(
      <StageTransition
        renderFrom={<div data-testid="outgoing" />}
        direction="forward"
        onDone={jest.fn()}
      >
    ...
    // Outgoing is whatever the caller renders (a real static board); the
    // incoming stage is the passed-in child. Both are mounted at once for
    // the slide.
