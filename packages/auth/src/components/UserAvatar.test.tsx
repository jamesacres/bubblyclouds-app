...
describe('UserAvatar', () => {
  ...
  describe('rendering with picture', () => {
    it('should render user image when picture is provided', () => {
      render(
        <UserAvatar enableAvatarPicture={true} user={mockUser} size={64} />
      );
    ...
    it('should not render user image when enableAvatarPicture is false', () => {
      render(
        <UserAvatar enableAvatarPicture={false} user={mockUser} size={64} />
      );
      let image;
      try {
    ...
    it('should set correct size when no ring is shown', () => {
      render(
        <UserAvatar enableAvatarPicture={true} user={mockUser} size={32} />
      );
      const image = screen.getByAltText('John Doe') as HTMLImageElement;
  ...
  describe('rendering without picture', () => {
    it('should render fallback icon when picture is not provided', () => {
      render(
        <UserAvatar
          enableAvatarPicture={true}
          user={mockUserNoPicture}
          size={64}
        />
      );
      const icon = screen.getByTestId('user-icon');
  ...
  describe('ring variant rendering', () => {
    ...
    it('should have correct ring dimensions with padding', () => {
      ...
      expect(ringDiv.style.height).toBe('68px');
      expect(ringDiv.style.width).toBe('68px');
    });
  ...
  describe('sizing', () => {
    it('should handle small size correctly', () => {
      render(
        <UserAvatar enableAvatarPicture={true} user={mockUser} size={24} />
      );
      const image = screen.getByAltText('John Doe') as HTMLImageElement;
    ...
    it('should handle medium size correctly', () => {
      render(
        <UserAvatar enableAvatarPicture={true} user={mockUser} size={48} />
      );
      const image = screen.getByAltText('John Doe') as HTMLImageElement;
    ...
    it('should handle large size correctly', () => {
      render(
        <UserAvatar enableAvatarPicture={true} user={mockUser} size={128} />
      );
      const image = screen.getByAltText('John Doe') as HTMLImageElement;
  ...
  describe('edge cases', () => {
    ...
    it('should handle zero size gracefully', () => {
      render(
        <UserAvatar enableAvatarPicture={true} user={mockUser} size={0} />
      );
      const image = screen.getByAltText('John Doe') as HTMLImageElement;
    ...
    it('should handle very large size', () => {
      render(
        <UserAvatar enableAvatarPicture={true} user={mockUser} size={1024} />
      );
      const image = screen.getByAltText('John Doe') as HTMLImageElement;
    ...
    it('should handle different user profiles consistently', () => {
      ...
      users.forEach((user) => {
        const { unmount } = render(
          <UserAvatar enableAvatarPicture={true} user={user} size={64} />
        );
        if (user.picture) {
